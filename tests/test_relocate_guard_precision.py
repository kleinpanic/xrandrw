...
# monitor -> refuse the move (return True). Never weaken to allow-by-default.
# ---------------------------------------------------------------------------
